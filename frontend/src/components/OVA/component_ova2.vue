					...
					<div class="four wide column">
						<div class="ui fluid inverted vertical menu">
							...
							<div role="tablist">
								...
								<b-card no-body class="mb-1">
									<b-card-header header-tag="header" class="p-1" role="tab">
										<b-button block href="#" v-on:click="componenteActual = 'introduccion'" variant="info">Conceptos</b-button>
									</b-card-header>
								</b-card>
								<b-card no-body class="mb-1">
									<b-card-header header-tag="header" class="p-1" role="tab">
										<b-button block href="#" v-on:click="componenteActual = 'Screen2'" variant="info">Sobrecarga</b-button>
									</b-card-header>
								</b-card>
								<b-card no-body class="mb-1">
									<b-card-header header-tag="header" class="p-1" role="tab">
										<b-button block href="#" v-on:click="componenteActual = 'introduccion'" variant="info">Sobreescritura</b-button>
									</b-card-header>
								</b-card>
								<b-card no-body class="mb-1">
									<b-card-header header-tag="header" class="p-1" role="tab">
										<b-button block href="#" v-on:click="componenteActual = 'introduccion'" variant="info">Variables polimórficas</b-button>
									</b-card-header>
								</b-card>
								<b-card no-body class="mb-1">
									<b-card-header header-tag="header" class="p-1" role="tab">
										<b-button block href="#" v-on:click="componenteActual = 'introduccion'" variant="info">Genericidad</b-button>
									</b-card-header>
								</b-card>
								<b-card no-body class="mb-1">
									<b-card-header header-tag="header" class="p-1" role="tab">
										<b-button block href="#" v-on:click="componenteActual = 'Screen'" variant="info">Genericidad</b-button>
									</b-card-header>
								</b-card>
