		...
		<hooper style="height: 480px">
			<slide id="Introduccion">
				<div class="slide_">
					...
					<p>Es una característica de la programación orientada a objetos y puede ser aplicada a constructores o métodos. Para que
						haya sobrecarga se debe cumplir que:
					</p>
					<ol>
